package com.kzk.jhipster.web.rest;

import com.kzk.jhipster.JhipsterSampleApplicationApp;

import com.kzk.jhipster.domain.Country;
import com.kzk.jhipster.repository.CountryRepository;
import com.kzk.jhipster.service.CountryService;
import com.kzk.jhipster.repository.search.CountrySearchRepository;
import com.kzk.jhipster.service.dto.CountryDTO;
import com.kzk.jhipster.service.mapper.CountryMapper;
import com.kzk.jhipster.web.rest.errors.ExceptionTranslator;
...
import static com.kzk.jhipster.web.rest.TestUtil.createFormattingConversionService;
...
public class CountryResourceIntTest {
    ...
    private static final String DEFAULT_REGION_2 = "AAAAAAAAAA";
    private static final String UPDATED_REGION_2 = "BBBBBBBBBB";
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getRegion2()).isEqualTo(DEFAULT_REGION_2);
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].region2").value(hasItem(DEFAULT_REGION_2.toString())));
    }
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.region2").value(DEFAULT_REGION_2.toString()));
    }
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getRegion2()).isEqualTo(UPDATED_REGION_2);
